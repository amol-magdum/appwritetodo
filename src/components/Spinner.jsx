...
function Spinner() {
  return (
    ...
    //   <svg
    //     aria-hidden="true"
    //     classNameName="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
    //     viewBox="0 0 100 101"
    //     fill="none"
    ...
    <div className="flex space-x-2 h-5 justify-center items-center bg-transparent dark:invert">
